...
<head>
    <meta charset="UTF-8">
    <title>后台登录-{{config('admin.admin_site')}}</title>
...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="{{url(config('admin.admin_uri'))}}">{{config('admin.admin_site')}}</a></div>
    <div class="left_open">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
                ...
                <dd><a href="{{url(config('admin.admin_uri').'/logout')}}">退出</a></dd>
            </dl>
        </li>
                        ...
                        <ul class="sub-menu">
                            @foreach($permission->menus as $menu)
                                <li>
                                    ...
                                    <a _href="{{url(config('admin.admin_uri').'/'.$menu->menu_path)}}">
                                        <i class="iconfont">&#xe6a7;</i>
